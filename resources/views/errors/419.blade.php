...
<head>
    ...
    <title>419 - Sesi Kedaluwarsa | PT Envirotama Solusindo</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-warn { display: inline-block; background: rgba(234, 179, 8, 0.15); color: #facc15; border: 1px solid rgba(234, 179, 8, 0.3); padding: 6px 16px; border-radius: 99px; font-size: 0.85rem; font-weight: 800; margin-bottom: 20px; }
...
<body>
    <div class="error-card">
        <span class="badge-warn">Sesi Kedaluwarsa (419)</span>
        <h1>Halaman Telah Kedaluwarsa</h1>
        <p>Sesi keamanan Anda telah habis atau token keamanan telah diperbarui. Silakan klik tombol di bawah untuk memuat ulang dan login kembali.</p>
        <div class="btn-group">
            <button onclick="window.location.reload()" class="btn btn-primary">🔄 Muat Ulang & Masuk Kembali</button>
        </div>
    </div>
</body>
</html>
